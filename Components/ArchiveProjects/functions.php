...
namespace Flynt\Components\ArchiveProjects;
...
add_filter('Flynt/addComponentData?name=ArchiveProjects', function ($data) {
    $postType = POST_TYPE;
...
function getACFLayout()
{
    return [
        ...
        'label' => __('Archive: Projects', 'flynt'),
        'sub_fields' => [
            [
...
Options::addTranslatable('ArchiveProjects', [
    [
