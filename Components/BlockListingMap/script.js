...
export default function (blockListingMap) {
  // find the project which is the highest and set the min height of the map to that
  const projectList = blockListingMap.getElementsByClassName('project-list')[0]
  const projects = blockListingMap.getElementsByClassName('project')
