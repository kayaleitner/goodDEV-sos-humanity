...
namespace Flynt\Components\BlockRelatedInsights;

use Flynt\FieldVariables;
use Flynt\Utils\Options;
use Timber\Timber;

add_filter('Flynt/addComponentData?name=BlockRelatedInsights', function ($data) {
...
Options::addTranslatable('BlockRelatedInsights', [
    [
