...
namespace Flynt\Components\BlockListingSelector;

use Flynt\FieldVariables;
use Flynt\Utils\Options;
use Timber\Timber;

// add_filter('Flynt/addComponentData?name=BlockListingSelector', function ($data) {
...
Options::addTranslatable('BlockListingSelector', [
    [
