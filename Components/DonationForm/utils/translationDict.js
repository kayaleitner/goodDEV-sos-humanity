const translationDict = {
  de: {
    ...
    max: 'Bitte einen Betrag kleiner oder gleich {0} eingeben.',
    step: 'Bitte einen gültigen Betrag mit maximal 2 Nachkommastellen eingeben.',
  ...
  it: {
    ...
    max: 'Inserisci un importo inferiore o uguale a {0}.',
    step: 'Inserisci un importo valido con un massimo di 2 cifre decimali.',
