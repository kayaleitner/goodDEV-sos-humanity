...
namespace Flynt\Components\BlockRelatedProjects;

use Flynt\FieldVariables;
use Flynt\Utils\Options;
use Timber\Timber;

add_filter('Flynt/addComponentData?name=BlockRelatedProjects', function ($data) {
...
Options::addTranslatable('BlockRelatedProjects', [
    [
