...
function registerDivisionTaxonomy()
{
    $labels = [
        'name'                       => _x('Division', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Division', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Divisions', 'flynt'),
    ...
    register_taxonomy('division', ['people'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerDivisionTaxonomy');
