...
function registerJobTaxonomy()
{
    $labels = [
        'name'                       => _x('Job Category', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Job Category', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Job Category', 'flynt'),
    ...
    register_taxonomy('jobCategory', ['job'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerJobTaxonomy');
